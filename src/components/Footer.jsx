        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-2">
            ...
            <p className="text-gray-400 text-sm sm:text-base mb-4 max-w-md">
              Your trusted platform for vehicle booking and trip management. 
              Explore, book, and manage vehicles with ease.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link 
                  to="/" 
                  className="text-gray-400 hover:text-primary transition-colors duration-200 text-sm sm:text-base inline-block"
                >
                  Home
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm sm:text-base">
              ...
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:info@travelease.com" className="hover:text-primary transition-colors duration-200">
                  info@travelease.com
                </a>
              </li>
              <li className="flex items-start gap-2">
        ...
        <div className="border-t border-dark-700 mt-6 sm:mt-8 pt-6 sm:pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
            ...
            <div className="flex flex-wrap justify-center sm:justify-end gap-3 sm:gap-4 text-xs sm:text-sm">
              ...
              <Link to="/cookies" className="text-gray-400 hover:text-primary transition-colors duration-200">
                Cookie Policy
              </Link>
            </div>
          </div>
