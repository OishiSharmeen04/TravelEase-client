...
const AllVehicles = () => {
  ...
  useEffect(() => {
    axios
      .get("https://travelease-server-roan.vercel.app/vehicles")
      .then((res) => {
        ...
        >
          ...
          {filteredVehicles.length > 0 ? (
            ...
            <div className="text-center py-20">
              ...
              <button
                onClick={resetFilters}
                className="btn btn-primary text-sm sm:text-base md:text-lg px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 inline-flex items-center gap-2 shadow-gold mt-5"
              >
                Clear All Filters
              </button>
            </div>
